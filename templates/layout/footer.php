   ...
   <div class="container">
        <div class="footer-article">
            <div class="row flex items-start justify-between">
                <div class="footer-news col-4 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="footer-news col-3 col-sm-3 col-md-3 col-lg-3">
        ...
        <section id="footer-powered">
            <div class="container">
                <div class="wrap-content d-flex align-items-center justify-content-center">
                    <p class="copyright"><i>Copyright 2023 3D Sky. Allright Reserved - Developed by A Website</i></p>
                </div>
            </div>
        </section>
   </div>
