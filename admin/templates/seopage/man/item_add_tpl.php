            ...
            <div class="card-body">
                <div class="form-group">
                    <label class="change-photo" for="file">
                        <p>Upload hình ảnh: <strong class="text-danger mt-2 mb-2 text-sm"><?php echo "Width: ".$config['seopage']['width']." px - Height: ".$config['seopage']['height']." px (".$config['seopage']['img_type'].")" ?></strong></p>
                        <div class="rounded">
                            <img class="rounded img-upload" src="<?=THUMBS?>/<?=$config['seopage']['thumb']?>/<?=UPLOAD_SEOPAGE_L.@$item['photo']?>" onerror="src='assets/images/noimage.png'" alt="Alt Photo"/>
                             <strong class="justify-content-start flex-row mt-2">
                                ...
                                <b class="text-sm text-split ml-2"></b>
                            </strong>
                        </div>
                    </label>
