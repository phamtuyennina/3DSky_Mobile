...
<?php
    ...
    $linkAdd = "index.php?com=product&act=add_cat&type=".$type."&p=".$curPage.((!empty($_GET['id_list']))?("&id_list=".$_GET['id_list']):'');
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php if(!empty($config['product'][$type]['show_images_cat']) && $config['product'][$type]['show_images_cat']==true) { ?>
                                            <td class="align-middle">
                                                <a href="<?=$linkEdit?><?=$linkID?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tenvi']?>"><img class="rounded img-preview" onerror="src='<?=THUMBS?>/64x64x1/assets/images/noimage.png'" src="<?=THUMBS?>/64x64x1/<?=UPLOAD_PRODUCT_L.$items[$i]['photo']?>" alt="<?=$items[$i]['tenvi']?>"></a>
                                            </td>
                                        <?php } ?>
                                        <td class="align-middle" >
                                            <h5 class="mb-0 text-default font-weight-normal"><a class="text-dark" href="<?=$linkEdit?><?=$linkID?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tenvi']?>"><?=$items[$i]['tenvi']?></a></h5>
