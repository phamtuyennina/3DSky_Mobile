<?php
    ...
    $linkSave = "index.php?com=product&act=save_properties&type=".$type."&p=".$curPage;
?>
    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Chi tiết Thuộc tính</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="change-photo" for="file-zone">
                                <p> <b class="text-gray-800">Upload hình ảnh:</b> <span class="text-danger mt-2 mb-2 text-sm"><?php echo "Width: ".$config['product'][$type]['width_properties']." px - Height: ".$config['product'][$type]['height_properties']." px (".$config['product'][$type]['img_type_properties'].")" ?></span></p>
                                <div class="rounded photoUpload-preview flex items-center justify-left " id="photoUpload-preview">
                                    <img class="rounded img-upload max-h-[300px]" src="<?=UPLOAD_MAU.$item['photo']?>" onerror="src='assets/images/noimage.png'" alt="Alt Photo"/>
                                </div>
                            </label>
