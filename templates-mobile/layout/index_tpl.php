<div class="wrap-show-product">
	<div class="container">
		<div class="row !-mx-[15px]">
			<div class="col-12 col-sm-12 col-md-9 mb-4 !px-[15px]">
				<div class="title-pages">
					<h4>New Model</h4>
				</div>
				<div class="row_show_model row -mx-[7.5px]">
					<?php $productnb = $d->rawQuery("SELECT id,photo,tenkhongdauvi,tenvi FROM #_product WHERE hienthi=1 AND type = ? AND moi>0 ORDER BY stt,id DESC limit 0,6",array('san-pham')); foreach ($productnb as $v) {?>
					<div class="col-6 col-sm-6 !px-[7.5px] mb-[15px]">
			...
			<div class="col-12 col-sm-12 col-md-3 !px-[15px]">
				<div class="title-pages flex items-center justify-between">
				...
				<div class="show-slider-right">
					...
					<div class="right-model last:ml-0">
						<div class="box-model">
							<a href="<?=$v['tenkhongdauvi']?>">
...
<div class="show_list_dnhmuc">
	<div class="container">
		<ul class="mansory-list row">
			...
			?>
			<li class="col-6 col-sm-6 col-md-3 mb-3 col-item">
				<p>
